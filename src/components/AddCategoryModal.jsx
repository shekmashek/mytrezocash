...
const AddCategoryModal = ({ isOpen, onClose, onSave, availableCategories, type, initialMainCategoryId }) => {
  ...
  const handleSubmit = (e) => {
    e.preventDefault();
    if (!mainCategoryId || !subCategoryName.trim()) {
      alert("Veuillez sélectionner une catégorie principale et donner un nom.");
      return;
    }
    onSave(type, mainCategoryId, subCategoryName.trim());
  };
      ...
      <div className="bg-white rounded-lg shadow-xl max-w-md w-full">
        ...
        <form onSubmit={handleSubmit} className="p-6 space-y-4">
          <div>
            ...
            >
              {availableCategories.map(mainCat => (
