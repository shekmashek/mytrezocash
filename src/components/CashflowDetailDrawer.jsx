                ...
                {transactions.map(tx => (
                  <li key={tx.id} className="p-3 bg-white rounded-lg border flex">
                    ...
                    <div className="flex-grow">
                      <div className="flex justify-between items-start mb-2"><div className="font-semibold text-gray-800 flex items-center gap-2"><User className="w-4 h-4 text-gray-500" />{tx.thirdParty}</div><div className="font-bold text-lg text-blue-600">{formatCurrency(tx.amount, settings)}</div></div>
